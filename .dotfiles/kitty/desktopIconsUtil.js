// Original: https://gitlab.gnome.org/World/ShellExtensions/desktop-icons/-/blob/f33300ae63d85932167014a163dbe0d52a8d741f/desktopIconsUtil.js
...
function launchTerminal(workdir) {
    ...
    let argv = [
        exec
        //, `--working-directory=${workdir}` Removed arg because it breaks kitty terminal 
    ];
